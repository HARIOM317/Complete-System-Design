...
public:
    ...
    PaymentGateway *getGateway(GatewayType type)
    {
        if (type == GatewayType::PAYTM)
        {
            ...
            return new PaymentGatewayProxy(paymentGateway, 3); // try 3 times
        }
        else
        {
            PaymentGateway *paymentGateway = new RazorpayGateway();
            return new PaymentGatewayProxy(paymentGateway, 2); // try 2 times
        }
    }
};
GatewayFactory GatewayFactory::instance; // Define static instance
...
int main()
{
    ...
    PaymentRequest *req1 = new PaymentRequest("Hariom", "Abhishek", 1000.0, "INR");
    ...
    PaymentRequest *req2 = new PaymentRequest("Abhishek", "Hariom", 500.0, "USD");
