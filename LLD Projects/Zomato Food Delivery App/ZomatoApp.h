...
public:
    ...
    {
        Restaurant *restaurant1 = new Restaurant("Bikaner", "Indore");
    ...
    Order *checkoutScheduled(User *user, const string &orderType, PaymentStrategy *paymentStrategy, const string &scheduledTime)
    {
    ...
    void printUserCart(User *user)
    {
        ...
        cout << "------------------------------------" << endl;
        cout << "Grand total : ₹ " << user->getCart()->getTotalCost() << "\n\n";
    }
};
