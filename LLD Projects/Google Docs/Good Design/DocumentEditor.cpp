...
class TextElements : public DocumentElement
{
private:
    string text;
...
// Concreate implementation for image elements
...
// FileStorage implements of Persistence
...
int main()
{
    ...
    editor->addText("keel learning, keep growing!");
